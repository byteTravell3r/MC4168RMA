...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = OLED_MI_Pin|OLED_MO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
  ...
  /* USER CODE END SPI5_MspInit 0 */
    ...
    PF8     ------> SPI5_MISO
    */
    GPIO_InitStruct.Pin = IMUI_SCK_Pin|IMU_NSS_Pin|IMU_MO_Pin|IMU_MI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, OLED_MI_Pin|OLED_MO_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF8     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(GPIOF, IMUI_SCK_Pin|IMU_NSS_Pin|IMU_MO_Pin|IMU_MI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = SERVO_PWM_A9_Pin|SERVO_PWM_A8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    ...
    GPIO_InitStruct.Pin = SERVO_PWM_E13_Pin|SERVO_PWM_E14_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = DBUS_RX_Pin|DBUS_TX_NC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, DBUS_RX_Pin|DBUS_TX_NC_Pin);
